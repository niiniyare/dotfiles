#!/usr/bin/env node
var W=Object.create;var G=Object.defineProperty;var X=Object.getOwnPropertyDescriptor;var K=Object.getOwnPropertyNames;var L=Object.getPrototypeOf,Q=Object.prototype.hasOwnProperty;var Z=(e,r,n,t)=>{if(r&&typeof r=="object"||typeof r=="function")for(let a of K(r))!Q.call(e,a)&&a!==n&&G(e,a,{get:()=>r[a],enumerable:!(t=X(r,a))||t.enumerable});return e};var o=(e,r,n)=>(n=e!=null?W(L(e)):{},Z(r||!e||!e.__esModule?G(n,"default",{value:e,enumerable:!0}):n,e));var N=require("commander"),Y=o(require("execa")),J=require("fs");var p=o(require("ora")),y=o(require("path")),i=o(require("chalk")),w=o(require("boxen"));var c=o(require("execa")),C=o(require("path")),R=o(require("rimraf"));function ee(e){try{return c.default.commandSync("git rev-parse --is-inside-work-tree",{stdio:"ignore",cwd:e}),!0}catch{}return!1}function te(e){try{return c.default.commandSync("hg --cwd . root",{stdio:"ignore",cwd:e}),!0}catch{}return!1}function _(e,r){let n=!1;try{c.default.commandSync("git --version",{stdio:"ignore",cwd:e})}catch{return"git-not-found"}if(ee(e)||te(e))return"already-in-repository";try{c.default.commandSync("git init",{stdio:"ignore",cwd:e})}catch{return"git-init-failed"}n=!0;try{c.default.commandSync("git checkout -b main",{stdio:"ignore",cwd:e}),c.default.commandSync("git add -A",{stdio:"ignore",cwd:e}),c.default.sync("git",["commit",`--message="${r}"`],{stdio:"ignore",cwd:e})}catch{if(n)try{R.default.sync(C.default.join(e,".git"))}catch{}return"git-commit-failed"}return"success"}var x=o(require("fs"));async function A(e,r={recursive:!0}){try{return x.default.existsSync(e)?"already":(await x.default.promises.mkdir(e,r),"success")}catch{return"failed"}}var P=o(require("got"));async function re(e){return(await P.default.head(e).catch(n=>n)).statusCode===200}async function F({organization:e,repository:r,example:n,branch:t}){return re(`https://api.github.com/repos/${e}/${r}/contents/examples/${encodeURIComponent(n)}?ref=${t}`)}var E=o(require("got")),T=o(require("tar")),V=require("stream"),z=require("util"),j=require("path"),d=require("fs"),ie=(0,z.promisify)(V.Stream.pipeline),ne=".refine-example.temp";async function oe(e){let r=(0,j.join)(process.cwd(),`${ne}-${Date.now()}`);try{return await ie(E.default.stream(e),(0,d.createWriteStream)(r)),r}catch{try{await d.promises.unlink(r)}catch{}return}}async function D({root:e,name:r,branch:n,repo:t,org:a}){let u=await oe(`https://codeload.github.com/${a}/${t}/tar.gz/${n}`);if(!u)return"download-failed";try{await T.default.x({file:u,cwd:e,strip:3,filter:s=>!!s.includes(`${t}-${n}/examples/${r}/`)})}catch{try{await d.promises.unlink(u)}catch{}return"extract-failed"}try{await d.promises.unlink(u)}catch{}return"success"}var H=o(require("execa")),U=o(require("which-pm-runs"));function b(){try{let{name:e}=(0,U.default)()||{};return e!=null?e:"npm"}catch{return"npm"}}async function B(e){try{return await(0,H.default)(b(),["install"],{cwd:e,stdio:"ignore"}),!0}catch{return!1}}var $="refinedev",S="refine",k="master";var ae=async(e,r)=>{let n=b();typeof e!="string"&&((0,p.default)("You must specify an example name").fail(),console.log((0,w.default)([i.default`You can find {bold refine} examples at:`,"",i.default`{dim.cyan github.com/}{cyan refinedev/refine/tree/master/examples}`].join(`
